...
//SayHelloObj struct
type SayHelloObj struct {
	s m.Servant
}

//Add is the proxy function for the method defined in the tars file, with the context
func (_obj *SayHelloObj) Add(a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *SayHelloObj) AddWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *SayHelloObj) AddOneWayWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *SayHelloObj) Sub(a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *SayHelloObj) SubWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *SayHelloObj) SubOneWayWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *SayHelloObj) SetServant(s m.Servant) {
	_obj.s = s
}

//TarsSetTimeout sets the timeout for the servant which is in ms.
func (_obj *SayHelloObj) TarsSetTimeout(t int) {
	_obj.s.TarsSetTimeout(t)
}

//TarsSetProtocol sets the protocol for the servant.
func (_obj *SayHelloObj) TarsSetProtocol(p m.Protocol) {
	_obj.s.TarsSetProtocol(p)
}

//AddServant adds servant  for the service.
func (_obj *SayHelloObj) AddServant(imp _impSayHelloObj, obj string) {
	tars.AddServant(_obj, imp, obj)
}

//AddServant adds servant  for the service with context.
func (_obj *SayHelloObj) AddServantWithContext(imp _impSayHelloObjWithContext, obj string) {
	tars.AddServantWithContext(_obj, imp, obj)
}

type _impSayHelloObj interface {
	Add(a int32, b int32, c *int32) (ret int32, err error)
	Sub(a int32, b int32, c *int32) (ret int32, err error)
}
type _impSayHelloObjWithContext interface {
...
func (_obj *SayHelloObj) Dispatch(tarsCtx context.Context, _val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, _withContext bool) (err error) {
	var length int32
	var have bool
	var ty byte
	...
	case "Add":
		...
		if _withContext == false {
			_imp := _val.(_impSayHelloObj)
			_funRet_, err = _imp.Add(a, b, &c)
		} else {
			_imp := _val.(_impSayHelloObjWithContext)
