...
func (_obj *SayHello) EchoHello(name string, greeting *string, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(tarsCtx, 0, "echoHello", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
func (_obj *SayHello) EchoHelloWithContext(tarsCtx context.Context, name string, greeting *string, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *SayHello) EchoHelloOneWayWithContext(tarsCtx context.Context, name string, greeting *string, _opt ...map[string]string) (ret int32, err error) {
	...
	err = _obj.s.Tars_invoke(tarsCtx, 1, "echoHello", _os.ToBytes(), _status, _context, _resp)
	if err != nil {
		return ret, err
	}
...
type _impSayHelloWithContext interface {
	EchoHello(tarsCtx context.Context, name string, greeting *string) (ret int32, err error)
}
...
func (_obj *SayHello) Dispatch(tarsCtx context.Context, _val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, _withContext bool) (err error) {
	...
	case "echoHello":
		...
		if _withContext == false {
			...
			_funRet_, err = _imp.EchoHello(name, &greeting)
		} else {
			_imp := _val.(_impSayHelloWithContext)
			_funRet_, err = _imp.EchoHello(tarsCtx, name, &greeting)
		}
		...
		if tarsReq.IVersion == basef.TARSVERSION {
			...
			_os.Reset()
			err = _os.Write_string(greeting, 0)
			if err != nil {
				return err
			}

			_tupRsp_.PutBuffer("greeting", _os.ToBytes())
